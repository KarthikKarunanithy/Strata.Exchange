...
{
    [EventSource(Name = "Strata-Exchange-Api")]
    internal sealed class ExchangeApiEventSource : EventSource
    {
        public static readonly ExchangeApiEventSource Current = new ExchangeApiEventSource();

        static ExchangeApiEventSource()
        {
        ...
        private ExchangeApiEventSource() : base() { }
