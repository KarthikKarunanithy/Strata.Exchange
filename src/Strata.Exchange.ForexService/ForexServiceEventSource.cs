...
[EventSource(Name = "Strata-Exchange-ForexService")]
internal sealed class ForexServiceEventSource : EventSource
{
    public static readonly ForexServiceEventSource Current = new ForexServiceEventSource();

    // Instance constructor is private to enforce singleton semantics
    private ForexServiceEventSource() : base() { }
